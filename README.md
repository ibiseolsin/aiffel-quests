...
| [agent-m07](agent-m07-cardnews-agent/) | **Main Quest** — 사용자 선택을 받아 카드뉴스를 만드는 웹앱 (PRD 바이브코딩 + 질문·재개) | 미착수 | 없음 — 로컬 웹앱 + 실행 증거 |
| [agentteam-m01](agentteam-m01-langgraph-workflow/) | LangGraph 실습 — 다섯 패턴 (LMS 제출 과제는 아니다) | 오케스트레이터-워커 실습 진행 중 (2026-09-11) | 없음 — 주피터 실습 |
